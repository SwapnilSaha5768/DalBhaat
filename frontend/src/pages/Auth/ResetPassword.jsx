            ...
            <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl transform transition-all duration-300 hover:shadow-2xl">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div>
                        ...
                        <input
                            type="password"
                            className={`w-full px-4 py-3 rounded-lg border ${errors.password ? 'border-red-500' : 'border-gray-200'} focus:border-[#ff1e00] focus:ring-4 focus:ring-[#ff1e00]/10 transition-all duration-200 outline-none`}
                    ...
                    <div>
                        ...
                        <input
                            type="password"
                            className={`w-full px-4 py-3 rounded-lg border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-200'} focus:border-[#ff1e00] focus:ring-4 focus:ring-[#ff1e00]/10 transition-all duration-200 outline-none`}
